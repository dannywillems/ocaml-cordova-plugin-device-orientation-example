# ocaml-cordova-plugin-device-orientation-example

This is an example of the binding to the *device-orientation cordova plugin*. See the
...
**The example isn't done. Please contribute**
...
* init_plugins: initialize plugins you need. Contains cordova-plugin-device-orientation
  for this project.
